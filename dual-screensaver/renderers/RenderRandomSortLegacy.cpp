...
namespace RandomSortLegacy {

struct SortStateLegacy {
...
void RenderRandomSortLegacy(HDC memDC, ScreenData* data, int width, int height, const RECT& rect) {
    auto& state = data->GetCustomState<SortStateLegacy>(33);
...
// Register as Screensaver ID 33
REGISTER_SCREENSAVER(
    33,
    L"Sorting Algorithms (Legacy)",
    "sort-legacy",
    { "sort-legacy", "legacy-sort", "sort-old" },
    WRAP_LEGACY(RandomSortLegacy::RenderRandomSortLegacy),
    GetSortSettings()
);
